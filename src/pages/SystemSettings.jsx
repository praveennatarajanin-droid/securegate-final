        ...
        <AdminLayout>
            <div style={{ maxWidth: '900px', margin: '0 auto', paddingBottom: '3rem' }}>
                <div style={{ marginBottom: '2.5rem' }}>
                    <h1 style={{ fontSize: '1.75rem', fontWeight: 700, margin: '0 0 0.5rem 0', color: 'var(--admin-text-main)' }}>System Configuration</h1>
                    ...
                    <div className="panel" style={{ padding: '2rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem' }}>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                ...
                                <input className="input-field" style={{ border: '1px solid var(--admin-border)', background: 'var(--admin-surface)', color: 'var(--admin-text-main)' }} value={general.name} onChange={e => setGeneral({ ...general, name: e.target.value })} />
                            </div>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                <label className="input-label">Contact Support</label>
                                <input className="input-field" style={{ border: '1px solid var(--admin-border)', background: 'var(--admin-surface)', color: 'var(--admin-text-main)' }} value={general.phone} onChange={e => setGeneral({ ...general, phone: e.target.value })} />
                            </div>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', gridColumn: '1 / -1' }}>
                                <label className="input-label">Official Address</label>
                                <input className="input-field" style={{ border: '1px solid var(--admin-border)', background: 'var(--admin-surface)', color: 'var(--admin-text-main)' }} value={general.address} onChange={e => setGeneral({ ...general, address: e.target.value })} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="panel" style={{ padding: '2rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem' }}>
                            <div>
                                ...
                                <input type="number" className="input-field" style={{ border: '1px solid var(--admin-border)', background: 'var(--admin-surface)', color: 'var(--admin-text-main)' }} value={security.timeout} onChange={e => setSecurity({ ...security, timeout: e.target.value })} />
                            </div>
                            <div>
                                <label className="input-label">Max Visitors Daily</label>
                                <input type="number" className="input-field" style={{ border: '1px solid var(--admin-border)', background: 'var(--admin-surface)', color: 'var(--admin-text-main)' }} value={security.maxVisitors} onChange={e => setSecurity({ ...security, maxVisitors: e.target.value })} />
                            </div>
                            <div style={{ gridColumn: '1/-1' }}>
                                <label style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}>
                                    ...
                                    <span style={{ fontWeight: 600, color: 'var(--admin-text-main)' }}>Enable Auto-Reject for unresponsive residents</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="panel" style={{ padding: '2rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                            <div style={{ gridColumn: '1/-1' }}>
                                ...
                                <input type="email" className="input-field" style={{ border: '1px solid var(--admin-border)', background: 'var(--admin-surface)', color: 'var(--admin-text-main)' }} value={admin.email} onChange={e => setAdmin({ ...admin, email: e.target.value })} />
                            </div>
